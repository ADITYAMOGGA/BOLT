...
export function Navigation() {
  ...
  return (
    <>
          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-4">
              ...
              <Button
                ...
                size="sm"
                onClick={toggleMenu}
                className="lg:hidden p-2 rounded-lg bg-gray-100 dark:bg-slate-700 text-gray-600 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-slate-600 transition-all duration-300"
              >
                {isMenuOpen ? (
                  <X className="w-5 h-5" />
                ) : (
      ...
      {/* Mobile Menu Overlay */}
      {isMenuOpen && (
        <div className="lg:hidden fixed inset-0 z-40 bg-black bg-opacity-50 animate-fade-in" onClick={toggleMenu}>
          {/* Mobile Menu Panel */}
          <div 
